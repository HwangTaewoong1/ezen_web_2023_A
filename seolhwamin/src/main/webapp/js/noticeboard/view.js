...
function getBoard(){
	...
	$.ajax({
		...
		success : r => {  console.log(r);
			...
			let fileLink = r.bfile ? `<a href="/seolhwamin/NoticeFileDownLoad?filename=${r.bfile}">${r.bfile}</a>` : '첨부 파일 없음';
			// 2. HTML 구성 
			let html = `<div class="content_top">
				...
				html += '<a href="noticelist.jsp"><button class="bottom" type="button">목록보기</button></a>';
