...
<body>
	...
	<div class="webcontainer">
		<h3 style="border-bottom: solid 2px #C7CBFF; padding-bottom: 10px;"> 공지사항 </h3>
		<form class="writeForm"> <!-- 쓰기 입력 구역 -->
			...
			<button class="bottom" onclick="bwrite()" type="button">글등록</button> 
			<a class="list bottom" href="list.jsp"> 목록보기 </a>
			<button class="reset bottom" type="reset" >다시쓰기</button>
		</form>
	</div>
	...
	<script src="../js/noticeboard/write.js" type="text/javascript"></script>
