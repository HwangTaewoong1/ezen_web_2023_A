...
// 1. 아임포트 관리자 식별키
IMP.init('imp28810543') // 예: 'imp00000000a'
    ...
    IMP.request_pay({
      ...
      buyer_postcode: "01181"
    	...
    	if(rsp.success){ // 결제 성공
			...
			imp_uid: "imp_051693378921"          --결제번호[DB저장]
			merchant_uid: "p1695348693092-"		 --주문번호[DB저장]
			pay_method: "card"					 --결제방식[DB저장]
