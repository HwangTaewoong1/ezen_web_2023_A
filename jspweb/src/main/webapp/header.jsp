...
<body>
	...
	<div>
		<ul>
			...
			<li> <a href="http://localhost/jspweb/member/signup.jsp">회원가입</a></li>
			<li> <a href="http://192.168.17.136/jspweb/%EA%B3%BC%EC%A0%9C/accountbook.jsp">과제1:가계부</a></li>
			<li> <a href="http://192.168.17.136/jspweb/%EA%B3%BC%EC%A0%9C/accountbook.jsp">과제2:독서관열람실</a></li>	
		</ul>
	</div>
