...
public class Ex1_예제 {
	public static void main(String[] args) {
		...
		// 5. 범위검색
		System.out.println(" 이진트리 80 이상  : " + scores.tailSet( 80 , true ) ); // tailSet ( 숫자 , true(이상) , false(초과) ) 
		System.out.println(" 이진트리 80 이상 90 초과  : " + scores.subSet( 80 , true , 90 , false ) ); // subSet ( 시작숫자 , 옵션 , 끝숫자 , 옵션) 
