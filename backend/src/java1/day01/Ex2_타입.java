...
public class Ex2_타입 { // class s
   ...
   public static void main(String[] args) { // main s
      ...
      int var1 = 0b1011; // (2진수) 데이터 앞에 0b 를 사용하면 2진수 사용가능 1011[2] -> 11 [10]
      ...
      // byte b3 = 200;   		System.out.println("b3 : " + b3);  	// 오류 : 허용 범위 벗어남
   
      // short 타입 [ -32,768 ~ 32,767 ]
      short s1 = 3200; 	    	System.out.println("s1 : " + s1);
      // short s2 = -50000; 	System.out.println("s2 : " + s2); // 오류 : 허용 범위 벗어남
      
      // int 타입 [ 대략 +- 21억 정도 ] * 정수 기본타입 : 1.우리가 코드로 적은 숫자 
      int i1 = 2000000000;    	System.out.println("i1 : " + i1);
      // int i2 = 3000000000; 	System.out.println("i2 : " + i2); 	// 오류 : 허용 범위 벗어남
      
      // long 타입 [ 억 - > 조 -> 경 대략 +- 1000경 , +- 21억 이상 자동] 
      long l1 = 10;				System.out.println("l1 : " + l1);
      // long l2 = 30000000000;	// 직접 작성한 정수 30억은 int타입	-> 기본/자동
      long l3 = 30000000000L;	// 직접 작성한 정수를 long 타입으로 변경 -> 정수 뒤에 L 붙이기
...
/*
   타입/자료형 : 데이터 저장할 때 사용되는 메모리 크기
      ...
      정수형타입
         ...
         short 		2바이트		[ -32,768 ~ 32,767 ] 대략 +-3만 정도
         *int    	4바이트 		[ 대략 +- 21억 정도 ] 
         long
      실수타입   
   ...
   // 용량단위 :
       (처리단위)비트 : 0,1 -> 1bit    -> 01010101 -> 8자리 -> 8bit -> 1byte
       (저장단위)바이트 : 1byte -> 1024byte -> 1Kbyte
       킬로바이트 : 1Kb -> 1024kb -> 1MB
       메가바이트 : 1mb -> 1024mb -> 1GB
   
   // 인코딩 : 2진수를 문자로 표하는 방법
       컴퓨터 : 010101010101 --> 사람 : ??????????
       컴퓨터 : 10000001 --> 규칙/패턴/해덕 (인코딩) ---> A
       아스키코드 : 7비트(확장8비트) -> 128문자 표현 1바이트 = 특수문자/숫자/영문
       유니코드 : 전세계 공용 문자 표현    		   2바이트 = 특수문자/숫자/영문 		
