...
public class Ex1_실행 {
	public static void main(String[] args) {
		...
		// 2. Car 객체의 타이어 장착 = Car 객체의 타이어 필드에 초기화
		myCar.tire = new Tire();
		...
		myCar.tire = new HankookTire(); // 한국타이어 객체를 대입 / 원래 기존에 있던 Tire객체는 GC 처리 
		System.out.println(myCar.tire);
		...
		myCar.tire = new KumhoTire(); // 금호타이어 객체를 대입 / 원래 기존에 있던 한국Tire객체는 GC 처리 
		System.out.println(myCar.tire);
