...
public class Car {
	...
	boolean isLeftGas( ) {
		...
		// 3. 리턴x매개변수x	: 필드의 gas가 0일때까지 gas 1씩차감하고 0이면 종료되는 함수
	void run() {
		while (true) {
			if (this.gas > 0) {
