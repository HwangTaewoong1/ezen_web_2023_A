...
console.log('data : ' + (데이터2++) )	// 10 에서 1증가 => 11 ???? 10	[출력 후에 증가]
console.log('data : ' + 데이터2 )		// 11
console.log('data : ' + (++데이터2) ) // 11 에서 1증가 => 12 ???? 12 [출력 전에 증가]

console.log('data : ' + (데이터2--) ) // 12 에서 1감소 => 11 ???? 12 [출력 후에 감소]
console.log('data : ' + 데이터2)		// 11
console.log('data : ' + (--데이터2) ) // 11 에서 1감소 => 10 ???? 10 [출력 전에 감소]
...
max = max < value5 ? value5 : max // 3. 만약에 max보다 세번째 입력값이 더 크면 max변수에 세번째 값으로 교체 / 아니면 그대로
