/*
	...
	- 제어문 = if = 만약에
		ex) 동생에게 집앞에 A,B,C 편의점에서 1000원 주고 콜라 사오기 심부름
		...
		3. if 형태
			...
			* 조건과 참/거짓의 코드가 이어져야한다. [ if(조건);참일경우코드]
			1. if( 조건 ) 참일경우코드
 ...
 */
// 1. if 형태1
if( 10 > 3 ) console.log(' 참[1] 10이 3보다 크다. ')		//조건이 참(true) 라서	console[o]
...
10 >= 20 ? console.log( '[참1] 10이 20보다 이상이다.')
	: 10 >= 15 ? console.log( '[참2] 10이 15보다 이상이다.')
		: 10 >= 10 ? console.log( '[참1] 10이 10보다 이상이다.')
			: console.log( '[거짓] 10이 더 작다.');