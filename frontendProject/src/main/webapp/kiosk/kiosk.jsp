		...
		<div class="kioskcontent"> <!-- 본문 : 제품출력/카트출력 구역 -->
			...
			<div class="productbox"> <!-- 제품구역 -->
				...
				<div class="product"> <!-- 제품 1개 기준 -->
					<img src="../img/헬로디아블로와퍼.png"/> <!-- 제품 이미지 -->
					<div class="pinfo">
						<div class="pname">헬로 디아블로 와퍼</div> <!-- 제품 이름 -->
						<div class="pprice">15,000원</div> <!-- 제품 가격 -->
					</div>
				</div>
            ...
            <div class = "cartcontent"> <!-- 제품개수/가격, 제품정보출력 -->
            
               <div class = "carttop"> <!-- 제품개수/총가격 출력구역 -->
